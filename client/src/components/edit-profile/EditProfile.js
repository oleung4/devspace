...
import { createProfile, getCurrentProfile } from "../../actions/profileActions"; // our create/edit profile logic is the same
...
class EditProfile extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.profile.profile) {
      ...
      profile.bio = !isEmpty(profile.bio) ? profile.bio : "";
      profile.social = !isEmpty(profile.social) ? profile.social : {}; // remember this is an object of social accounts
          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <div className="mb-3">
                  <button
                    type="button" // required if you don't want default submit behavior
